...
class Task1Steps {
    ...
    static Search(){
        ...
        cy.get('[class="_846x3h3 _846x3h4 _18krchz0"]').click()
        cy.get("[data-test-id='CT-Search-Input']").type('Emmaline Dress Black') //Jika barang habis ganti jenis produk disini
        cy.get('[class="ellipsis-two-lines"]').eq(1).click()
    ...
    static NewSearch(){
        cy.get('[class="_846x3h3 _846x3h4 _18krchz0"]').click()
        cy.get("[data-test-id='CT-Search-Input']").type('Check Cotton Regular Fit Shirt Archive Beige') //Jika barang habis ganti jenis produk disini
        cy.get('[class="ellipsis-two-lines"]').eq(0).click()
        cy.get('[data-test-id="CT_component_image_list-CT_component_VariantColorItem"]').should('exist')
        cy.get('[data-test-id="CT_component_image_list-CT_component_VariantColorItem"]').click()
    }

    static Addtocart(){
        cy.get('[class="_920fuu5 _920fuuf _920fuub _920fuu6 _920fuui"]').eq(0).click()
    }
