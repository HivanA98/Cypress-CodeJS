...
export default function createTests(registry: Registry, seed: number, source: string, gherkinDocument: messages.GherkinDocument, pickles: messages.Pickle[], isTrackingState: boolean, omitFiltered: boolean, stepDefinitionHints: {
