...
export declare class Registry {
    ...
    defineRunHook(keyword: RunHookKeyword, options: IRunHookOptions, fn: IRunHookBody): void;
    defineBeforeAll(options: IRunHookOptions, fn: IRunHookBody): void;
    defineAfterAll(options: IRunHookOptions, fn: IRunHookBody): void;
    ...
    runStepDefininition(world: Mocha.Context, text: string, dryRun: boolean, argument?: DataTable | string): unknown;
